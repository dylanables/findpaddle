    ...
    <>
      ...
      <div className='body-container'>
        <div className='hero'>
          ...
          <div className='center-items'>
            <div className='tool'>
              ...
              <Link to={'/search'}><Button size="large" variant="contained" endIcon={<SearchIcon />}>Search</Button></Link>
            </div>
            <div className='tool'>
              ...
              <Link to={'/quiz'}><Button size="large" variant="contained" endIcon={<QuizIcon />}>Take Quiz</Button></Link>
            </div>
            <div className='tool'>
              ...
              <Link to={'/similar'}><Button size="large" variant="contained" endIcon={<CompareArrowsIcon />}>Find Similar</Button></Link>
            </div>
          </div>
        ...
        <div className='why'>
          ...
          <div className='center-items'>
            <div>
              <img src='../public/findpaddle_search.png' alt='' className='why-img'/>
              <h3>Trust the Data</h3>
            </div>
            <div>
            <img src='../public/findpaddle_money.png' alt='' className='why-img'/>
              <h3>Save Money</h3>
            </div>
            <div>
              <img src='../public/findpaddle_podium.png' alt='' className='why-img'/>
