...
function Guide() {
  ...
  return (
    <>
      <Helmet>
        <title>Paddle Guide | FindPaddle: Find your perfect pickleball paddle!</title>
      ...
      <Container>
        <section className='margintop'>
            ...
            <p>
                When determining which paddle is right for you, it's important to consider its construction (materials) and specifications (size). 
                This guide is meant to educate on these aspects and how to choose based on your skill level and play style.
            </p>
            
            <h2>Paddle Construction Basics</h2>
